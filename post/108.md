...
- 官方自带 : redis-cluster 需要redis-3.0以上的版本
  ...
  - ![redis-cluster结构图](http://www.skydrift.cn/wordpress/wp-content/uploads/2016/04/redis-cluster-art.jpg)
- 开源的集群代理主要的实现有[dynomite][15]，[twemproxy][16]，[codis][17]
  - 代理则不一致，代理主要面对的是另一种应用场所
  - ![twemproxy的部署图](http://www.skydrift.cn/wordpress/wp-content/uploads/2016/04/twemproxy-deploy.jpg)
